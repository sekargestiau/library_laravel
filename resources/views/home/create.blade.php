...
@section('title','Usulan Buku Perpustakaan MCU')
    ...
    <h1 style="margin-left:50px; margin-right:50px;">Form Usulan Buku Perpustakaan MCU<br></h1>
    <br>
    <form class="row g-3" action="{{ url('books')}}" method="post" enctype="multipart/form-data" style="margin-left:50px; margin-right:50px;">
    @csrf
        <div class="col-md-5">
