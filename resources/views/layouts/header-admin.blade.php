            ...
            <div class="container-fluid">
              ...
              <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <li class="nav-item" style="background-color: rgb(244, 172, 78);">
                    <a class="nav-link" aria-current="page" href="{{url('admin-home')}}" style="color: rgb(0, 0, 0);">Home</a>
                  </li>
                  <!-- <li class="nav-item">
                    <a class="nav-link" href="profil.php" style="color: rgb(0, 0, 0);">Profil</a>
                  </li> -->
                  <li class="nav-item">
                    <a class="nav-link" href="{{url('admin-books')}}" style="color: rgb(0, 0, 0);">Data Buku</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="{{url('admin-user')}}" style="color: rgb(0, 0, 0);">Data User</a>
                  </li>
                  <!-- <li class="nav-item">
